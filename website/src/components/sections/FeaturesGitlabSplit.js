...
const FeaturesGitlabSplit = ({
  ...
  const sectionHeader = {
    ...
    paragraph: 'Integrate Vilicus in your GitlabCI.'
  };
          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              ...
              <div className={
                ...
                <Image
                  src={require('./../../assets/images/gitlab-ci.png')}
                  alt="GitlabCI Template"
                  width={528}
                  height={396} />
              </div>
            </div>
            ...
            <div className="split-item">
              ...
              <div className={
                ...
                data-reveal-container=".split-item">
                <Image
                  src={require('./../../assets/images/gitlab-sec.png')}
                  alt="Gitlab Security Tab"
                  width={528}
                  height={396} />
              </div>
            </div>
...
FeaturesGitlabSplit.propTypes = propTypes;
FeaturesGitlabSplit.defaultProps = defaultProps;

export default FeaturesGitlabSplit;