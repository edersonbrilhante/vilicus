...
const FeaturesTiles = ({
  ...
  const sectionHeader = {
    title: 'Analyze up the whole picture',
    paragraph: 'This project comes to help the developers to improve the quality of their container images by finding vulnerabilities and thus addressing them with agnostic sight from vendors.'
  };
            ...
            <div className="tiles-item reveal-from-bottom" data-reveal-delay="400">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    Vendors need to sync the vulnerabilities database, taking a lot of time. 
                    Vilicus provides daily snapshots of the databases, allowing the sync to be ready for use in few seconds rather than hours.
                    </p>
                </div>
              </div>
            </div>
