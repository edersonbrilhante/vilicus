...
const FeaturesGithubSplit = ({
  ...
  const sectionHeader = {
    ...
    paragraph: 'Integrate Vilicus in your Github Workflow.'
  };
          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              ...
              <div className={
                ...
                <Image
                  src={require('./../../assets/images/github-action.png')}
                  alt="Github Action"
                  width={528}
                  height={396} />
              </div>
            ...
            <div className="split-item">
              ...
              <div className={
                ...
                data-reveal-container=".split-item">
                <Image
                  src={require('./../../assets/images/github-sec.png')}
...
FeaturesGithubSplit.propTypes = propTypes;
FeaturesGithubSplit.defaultProps = defaultProps;

export default FeaturesGithubSplit;